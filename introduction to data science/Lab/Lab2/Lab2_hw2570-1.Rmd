...
(b) You'll probably want to use the **coefficients()** function.
...
(1) Let **Cu** and **Cl** be the upper and lower limits of the confidence interval.  Use the **quantile()** function to find the $0.025$ and $0.975$ quantiles of the vector **diff_estimates** calculated in B(5).  Then **Cu** is the sum of the original estimate of $\hat{\beta}_1$ from **lm0** with the upper quantile and **Cu** is the sum of the original estimate of $\hat{\beta}_1$ from **lm0** with the lower quantile.
